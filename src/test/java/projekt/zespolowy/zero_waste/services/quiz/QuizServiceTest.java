...
class QuizServiceTest {
    ...
    void setUp() {
        ...
        answers1.add(answerDto2);
        QuestionDto questionDto1 = new QuestionDto(null, "Question 1?", answers1, 1);
        ...
        answers2.add(answerDto3);
        answers2.add(answerDto4);
        QuestionDto questionDto2 = new QuestionDto(null, "Question 2?", answers2, 0);

        List<QuestionDto> questions = new ArrayList<>();
        questions.add(questionDto1);
        questions.add(questionDto2);
        quizDto = new QuizDto(null, "Test Quiz", "Test Description", null, questions);
        quizDto.setCreatorUsername(testUser.getUsername());
    }
    ...
    void createQuiz_UserNotLoggedIn() {
        // Mock getCurrentUser to return null for this test
    ...
    // Helper method to create a full Quiz entity for testing
